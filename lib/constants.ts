...
export const STAGES = [
    ...
    { num: 7, name: "Lifting", slug: "follow-up-vendor", icon: Phone },
    ...
    { num: 12, name: "Vendor Payment", slug: "vendor-payment", icon: CreditCard },
    { num: 13, name: "Freight Payments", slug: "freight-payments", icon: Truck },
    { num: 14, name: "Order Cancel", slug: "order-cancel", icon: XCircle },
];
